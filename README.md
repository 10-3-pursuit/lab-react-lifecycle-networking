...
There are several ways to solve this exercise, but always remember, it is always preferable and less expensive to hit the api endpoints as few times as possible.
